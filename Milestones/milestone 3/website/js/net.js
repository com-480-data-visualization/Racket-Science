...
function updateNetYears() {
    const circuit = document.getElementById('circuit-select-net-bubble').value;
    const category = document.getElementById('category-select-net-bubble').value; 
    const yearSelect = document.getElementById('year-select-net-bubble');
...
document.getElementById('circuit-select-net-bubble').addEventListener('change', updateNetYears);
